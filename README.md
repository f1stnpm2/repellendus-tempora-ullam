...
<div align="center">
  <a href="https://www.npmjs.com/package/@f1stnpm2/repellendus-tempora-ullam" target="_blank">
    <img alt="npm" src="https://img.shields.io/npm/v/@f1stnpm2/repellendus-tempora-ullam.svg?maxAge=0&style=flat" />
  </a>
  <a href="https://codecov.io/gh/mrsteele/@f1stnpm2/repellendus-tempora-ullam" target="_blank">
    <img alt="codecov" src="https://codecov.io/gh/mrsteele/@f1stnpm2/repellendus-tempora-ullam/branch/master/graph/badge.svg" />
  </a>
  <a href="https://github.com/f1stnpm2/repellendus-tempora-ullam/actions/workflows/main.yml" target="_blank">
    <img alt="Main" src="https://github.com/f1stnpm2/repellendus-tempora-ullam/actions/workflows/main.yml/badge.svg" />
  </a>
  <img alt="Vulnerabilities Score" src="https://snyk-widget.herokuapp.com/badge/npm/@f1stnpm2/repellendus-tempora-ullam/badge.svg" />
  <img alt="Known Vulnerabilities" src="https://snyk.io/test/github/mrsteele/@f1stnpm2/repellendus-tempora-ullam/badge.svg" />
  <object id="badge" data="https://snyk-widget.herokuapp.com/badge/npm/@f1stnpm2/repellendus-tempora-ullam/badge.svg" type="image/svg+xml"></object>
...
If you are running into issues where you or another package you use interfaces with `process.env`, it might be best to set `ignoreStub: true` and make sure you always reference variables that exist within your code (See [this issue](https://github.com/f1stnpm2/repellendus-tempora-ullam/issues/271) for more information).
